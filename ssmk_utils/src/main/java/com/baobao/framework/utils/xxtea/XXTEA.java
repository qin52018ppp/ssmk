...
package com.baobao.framework.utils.xxtea;
...
public final class XXTEA {
    ...
    private static final String xxTeaKey = "bxj&*^^$&(_$^*&(2016";
    ...
    public static String encryptData(String content) {
        return encryptToBase64String(content, xxTeaKey);
    }

    public static String decryptData(String content) {
        return decryptBase64StringToString(content, xxTeaKey);
    }



    public static void main(String[] args) {
        String str = "LOL SDFFGDSGFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF";
        String key = "bxj2016";
        ...
        String decrypt_data = XXTEA.decryptBase64StringToString("1eceQnRfZ+kJk/fI2YdUJM3GnxxG6upJJNNqwy5LtisVaX+UqolsGdCs7jjCT+0tF29lopfWCy8xBjt0YkhFUxOUKYFlwAqRsKItIxkwqY36ZK8fQUgRA5A==", key);
        System.out.println(encryptData("秦岭"));
        System.out.println(decryptData("EUCHXbw1de25oILu"));
